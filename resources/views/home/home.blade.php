...
<main>
        <main class="main">
            <section class="cover">
                <h1 id="slogan">Make your POWER</h1>
                <p class="covertext">
            ...
            <section class="cards">
                <div class="row wrapper card_s animated  bounceIn">
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                        <div class="card-body grey">
                            <h5 class="card-title">25% Discount</h5>
            ...
            <section class="Gymclass">
                ...
                <div class=" row Gymclasswrapper">
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                        <img src="/images/gim1.jpg" class="gym-img">
                        <span class="cls">
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                        <img src="/images/gim2.jpg" class="gym-img">
                        <span class="cls">
                ...
                <div class="container">
                    <div class="row row-f">
                        <div class="col-md-3 col-sm-6 col-xs-12 col-f">
                            ...
                            <div class="ftr-text">
                                <p>125/3 S.Lincoln St.</p>
                                <p>Washington DC</p>
                                <p>Phone: 202.458.6016</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 col-f">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 col-f">
                            ...
                            <div class="ftr-text">
                                ...
                                <p class="ftr-hours">07:00 - 21:00</p>
                                <p>Weekdays Saturday - Sunday</p>
                                <p class="ftr-hours">09:00 - 19:00</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 col-f">
                            <div class="ftr-img">
                                <img src="/images/ftr.jpg" alt="ftr" >
                            </div>
                        </div>
                    </div>
                </div>
