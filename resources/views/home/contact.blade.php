      ...
      <div class="row">
        <div class="col-md-12 banner_img text-white">
          <div class="col-md-6 img_opacity">
            <img src="/storage/general-usage/We Are Just a Step Closer.png" alt="img" class="img-fluid img_1" />
            <img src="/storage/general-usage/content.png" alt="img" class="img-fluid img_2" />
          </div>
        </div>
      </div>
    ...
    <div class="container bg_light bg-white">
      <div class="row">
        ...
        <div class="col-md-5 ml-auto text-white pt- pb-4 bg_dark">
          <div class="pt-5 px-4">
            <img src="/storage/general-usage/email.png" alt="img" class="img-fluid" />
            <p class="ml-5">joinus@power.com</p>
          </div>

          <div class="pt-5 px-4">
            <img src="/storage/general-usage/map.png" alt="img" class="img-fluid" />
            <p class="ml-5">125/3 S.Lincoln St., Washington DC </p>
          </div>

          <div class="pt-5 px-4">
            <img src="/storage/general-usage/phone.png" alt="img" class="img-fluid" />
            <p class="ml-5">202.458.6016</p>
          </div>

          <div class="pt-5 px-4">
            <img src="/storage/general-usage/wall-clock.png" alt="img" class="img-fluid" />
